...
from odineaudioreceiver.audio.i2s import (
    CaptureResult,
    capture_ptt_pcm,
    configure_ape,
...
from odineaudioreceiver.errors import ApiError
...
class RFInputService:
    def __init__(
        ...
        submitter: Callable[[Optional[Settings], str]],
    ...
    async def _run(self) -> None:
        while True:
            ...
            try:
                ...
                created = await self._submitter(self._settings, wav_path)
                try:
